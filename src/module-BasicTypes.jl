...
"""
`module  JAC.BasicTypes`  
    ... a submodel of JAC that contains many basic types/struct that are specific to the JAC module; we shall use proper 
        docstrings in order to allow easy access to the individual subcomponents of each type/struct definition.
"""
module BasicTypes
