...
function provide(sa::String, sh::Subshell, occ::Int64)
    ...
    if       subshell_2j(sh) == 1
        if       occ == 0  || occ == 2      push!( wb, SubshellStateR( sh, occ, 0, 0) );       return(wb)
        elseif   occ == 1                   push!( wb, SubshellStateR( sh, occ, 1, 1) );       return(wb)
        end
    elseif   subshell_2j(sh) == 3
        if       occ == 0  || occ == 4      push!( wb, SubshellStateR( sh, occ, 0, 0) );       return(wb)
        elseif   occ == 1  || occ == 3      push!( wb, SubshellStateR( sh, occ, 1, 3) );       return(wb)
        elseif   occ == 2                   push!( wb, SubshellStateR( sh, occ, 0, 0) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 4) );       return(wb)
        end
    elseif   subshell_2j(sh) == 5
        if       occ == 0  || occ == 6      push!( wb, SubshellStateR( sh, occ, 0, 0) );       return(wb)
        elseif   occ == 1  || occ == 5      push!( wb, SubshellStateR( sh, occ, 1, 5) );       return(wb)
        elseif   occ == 2  || occ == 4      push!( wb, SubshellStateR( sh, occ, 0, 0) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 4) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 8) );       return(wb)
        elseif   occ == 3                   push!( wb, SubshellStateR( sh, occ, 1, 5) )
                                            push!( wb, SubshellStateR( sh, occ, 3, 3) )
                                            push!( wb, SubshellStateR( sh, occ, 3, 9) );       return(wb)
        end
    elseif   subshell_2j(sh) == 7
        if       occ == 0  || occ == 8      push!( wb, SubshellStateR( sh, occ, 0, 0) );       return(wb)
        elseif   occ == 1  || occ == 7      push!( wb, SubshellStateR( sh, occ, 1, 7) );       return(wb)
        elseif   occ == 2  || occ == 6      push!( wb, SubshellStateR( sh, occ, 0, 0) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 4) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 8) )
                                            push!( wb, SubshellStateR( sh, occ, 2,12) );       return(wb)
        elseif   occ == 3  || occ == 5      push!( wb, SubshellStateR( sh, occ, 1, 7) )
                                            push!( wb, SubshellStateR( sh, occ, 3, 3) )
                                            push!( wb, SubshellStateR( sh, occ, 3, 5) )
                                            push!( wb, SubshellStateR( sh, occ, 3, 9) )
                                            push!( wb, SubshellStateR( sh, occ, 3,11) )
                                            push!( wb, SubshellStateR( sh, occ, 3,15) );       return(wb)
        elseif   occ == 4                   push!( wb, SubshellStateR( sh, occ, 0, 0) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 4) )
                                            push!( wb, SubshellStateR( sh, occ, 2, 8) )
                                            push!( wb, SubshellStateR( sh, occ, 2,12) )
                                            push!( wb, SubshellStateR( sh, occ, 4, 4) )
                                            push!( wb, SubshellStateR( sh, occ, 4, 8) )
                                            push!( wb, SubshellStateR( sh, occ, 4,10) )
