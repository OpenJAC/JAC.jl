...
"""
`JAC.analyze()`  ... analyzes various data structures with regard to requested details.
...
"""
function analyze(sa::String, level::Level)
...
"""
function analyze(sa::String, level::Level, N::Int64)
...
"""
`JAC.analyzeConvergence()`  ... analyzes the convergence for two (subsequently generated) orbitals or related quantities; a value::Float64 is
...
"""
function analyzeConvergence(a::JAC.Radial.Orbital, b::JAC.Radial.Orbital)
