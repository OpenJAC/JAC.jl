...
println("Ak) Test of restricted-active-space (RAS) computations.")
println("Al) Test of the GreenFunction module with ASF from an internally generated multiplet.")
println("")
