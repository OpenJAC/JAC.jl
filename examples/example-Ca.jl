...
if  false
    ...
    wa = Atomic.Computation(Atomic.Computation(), name="xx", grid=grid, nuclearModel=Nuclear.Model(26.), asfSettings=asfSettings,
                            ...
                            einsteinSettings=Einstein.Settings([E1], true, LineSelection(false), 0., 0., 10000. ) )
...
elseif  false
    ...
    wa = Atomic.Computation(Atomic.Computation(), name="xx", grid=grid, nuclearModel=Nuclear.Model(36.), 
                            ...
                            einsteinSettings=Einstein.Settings([E1], true, LineSelection(true, indexPairs=[(13,0), (15,0)]), 0., 0., 10000. ) )
                            ## einsteinSettings=Einstein.Settings([M2], true, LineSelection(true, indexPairs=[(13,2), (15,5), (15,4)]), 0., 0., 10000. ) )
...
elseif  false
    ...
    wa = Atomic.Computation(Atomic.Computation(), name="xx", grid=grid, nuclearModel=Nuclear.Model(36.), 
                            ...
                            einsteinSettings=Einstein.Settings([E1, M1, E2], true, LineSelection(), 0., 0., 10000. ) )
                            ## einsteinSettings=Einstein.Settings([M2], true, LineSelection(true, indexPairs=[(13,2), (15,5), (15,4)]), 0., 0., 10000. ) )
