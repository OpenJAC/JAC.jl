#
println("Hb) Tests of the StrongField module to calculate ATI energy distributions in the SFA with hydrogen-like initial states.")
...
if true
    ...
    StrongField.exportData([SFIComp], [SFIData], "example-Hb")
    StrongField.plot([SFIComp], [SFIData], "omega", "linear", "example-Hb")
end
